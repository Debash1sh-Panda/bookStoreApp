...
function SignUp() {
  ...
  const onSubmit = async (data) => {
    ...
    await axios.post("http://localhost:4001/book/user/signup", userInfo)
    .then((res)=> {
      ...
      <div className="w-[600px]">
            <div className="modal-box ">
                ...
                <div className='mt-4 space-y-2'>
                    <span>Full Name</span>
                    <br/>
                    <input type='text' placeholder='Enter your FullName' className='w-80 px-3 py-1 border rounded-md outline-none' {...register("fullname", { required: true })} /><br/>
